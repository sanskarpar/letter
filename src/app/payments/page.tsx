    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold mb-4">Current Plan Status</h2>
              ...
              >
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center">
                    ...
                    <span>5 free credits every month</span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
                    <span>{plan.credits} bonus credits monthly</span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-green-500 mr-2">✓</span>
        ...
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-8">Buy Additional Credits</h2>
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <div className="text-center mb-6">
              <p className="text-gray-600">
                Need more credits? Purchase additional credits at €1 for 5 credits.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {CREDIT_PACKAGES.map((pkg) => (
                <div key={pkg.credits} className="border rounded-lg p-4 text-center hover:shadow-md transition-shadow">
                  ...
                  <div className="text-xl font-semibold mb-3">€{pkg.price}</div>
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <ul className="space-y-1 text-gray-600">
                  <li>• 5 free credits every month</li>
                  <li>• Credits reset monthly</li>
                  <li>• Limited features</li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold mb-2">Paid Plans:</h4>
                <ul className="space-y-1 text-gray-600">
